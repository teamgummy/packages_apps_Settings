...
public class GeneralSettings extends SettingsPreferenceFragment {
    ...
    private static final String 180_DEGREE = "180_degree";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        m180Degree = (CheckBoxPreference) prefSet.findPreference(180_DEGREE);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (preference == m180Degree) {
            ...
            Settings.System.putInt(getContentResolver(),
                Settings.System.KILL_APP_LONGPRESS_BACK, value ? 1 : 0);
            return true;
        }
        return false;
    }
